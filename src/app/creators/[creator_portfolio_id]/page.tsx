...
.mcp-nav-actions{display:flex;align-items:center;gap:8px;flex-shrink:0;margin-left:auto;}
        ...
        .mcp-hour{padding:7px 12px;border-radius:8px;font-size:11.5px;font-weight:600;background:var(--mcp-bg3);border:1px solid var(--mcp-border2);color:var(--mcp-text2);font-family:inherit;white-space: nowrap;display: inline-flex;align-items: center;}
