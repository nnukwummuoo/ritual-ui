              ...
              {selectedFileModal.type === 'image' && (
                <Image
                  ...
                  onError={(e) => {
                    ...
                    const queryUrlFallback = selectedFileModal.fileUrl ? `https://backendritual.work/api/image/view?publicId=${encodeURIComponent(selectedFileModal.fileUrl)}` : "";
                    const pathUrlFallback = selectedFileModal.fileUrl ? `https://backendritual.work/api/image/view/${encodeURIComponent(selectedFileModal.fileUrl)}` : "";
