...
import { createWeb3Payment, checkWeb3PaymentStatus, cancelWeb3Payment } from "@/api/web3payment";
  ...
  const pay = async () => {
    ...
    try {
      ...
      if (paymentMethod === 'web3') {
        ...
        setWeb3Payment(res);
        toast.success("Web3 payment created! Check the details below.", { autoClose: 5000 });
      } else {
