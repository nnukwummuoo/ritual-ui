        ...
        <div style={{ padding: '28px 20px 60px', maxWidth: 480, margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div>
            ...
            {[
              ...
              { icon: '⏰', bg: 'rgba(244,114,182,.1)',  title: 'The 24-hour window keeps fans coming back', desc: 'Because Rituals disappear after 30 days, that FOMO keeps fans opening mmeko every day.', badge: 'Fans return daily', badgeBg: 'rgba(34,197,94,.1)', badgeColor: '#22c55e' },
            ].map((tip, i) => (
