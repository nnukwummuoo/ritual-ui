...
import { unverifiedHost } from "@/store/creatorSlice";
...
export default function VerifyCreators() {
  ...
  const status = useSelector((s: RootState) => s.creator.unverifiedhoststatus);
  const hosts = useSelector((s: RootState) => s.creator.Listofunverifiedhost as any[]);
  ...
  return (
    <div className="min-h-screen w-screen mx-auto sm:w-11/12 md:w-10/12 lg:w-9/12 xl:w-9/12 mt-14 md:mt-8">
      <div className="flex flex-col items-center w-full mt-12">
        <p className="jost text-[1.3em] text-white py-4 font-[500]">Verify new creators</p>
