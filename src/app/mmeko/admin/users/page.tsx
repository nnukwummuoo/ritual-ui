...
useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-[#080b14] rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      {showNotificationModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-[#080b14] rounded-lg max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
