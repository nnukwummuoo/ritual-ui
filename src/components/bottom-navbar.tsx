...
export default function BottomNavBar() {
  ...
  return (
    <MenuProvider>
      <div className=" h-fit mr-8 fixed right-0 top-1 z-[90] md:z-[200] max-[600px]:top-auto max-[600px]:m-0 max-[600px]:bottom-6 max-[600px]:w-full">
        <div className="w-[25rem] mx-auto max-[600px]:w-[90%] rounded-2xl px-4 pt-2 pb-1 bg-gray-900 flex justify-between max-[500px]:w-[93%] bottom-4">
          {routes.map((item, i) => (
