...
export default function StartGettingRequestsBanner() {
  ...
  const isCreatorVerified = useSelector((s: RootState) => (s.profile as any).creator_verified === true);
  ...
  const buttonState = hasPortfolio ? "copy" : isCreatorVerified ? "create" : "become";

  const handleButtonClick = () => {
    if (buttonState === "become") {
