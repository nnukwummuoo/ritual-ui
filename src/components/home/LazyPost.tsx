...
const PostSkeleton = () => (
  <div className="mx-auto max-w-[30rem] w-full bg-[#111624] rounded-2xl p-3.5 animate-pulse">
    <div className="flex items-center gap-2.5 mb-2">
      <div className="w-8 h-8 bg-gray-700 rounded-full flex-shrink-0"></div>
      <div className="flex-1 flex items-center gap-1.5">
        <div className="h-3.5 bg-gray-700 rounded w-20"></div>
    ...
    <div className="w-full aspect-[4/5] bg-gray-700 rounded-xl mb-2.5"></div>
...
const clampAspectRatio = (ratio: number) => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      {
        rootMargin: '1000px', // Start loading when post is 1000px away from viewport (aggressive preload)
