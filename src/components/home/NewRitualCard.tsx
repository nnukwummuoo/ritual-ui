        ...
        <div className="w-full bg-[#0a0a1a] rounded-xl overflow-hidden relative border border-purple-500/20 shadow-lg shadow-purple-900/20">
            ...
            <div className="relative z-10 p-6 flex items-center justify-between gap-4">
                ...
                <div className="flex flex-col leading-none">
                    <span className="text-[#F5E6CC] font-bold text-3xl tracking-tighter">NEW</span>
                    <span className="text-[#F5E6CC] font-bold text-3xl tracking-tighter">RITUAL</span>
                </div>

                {/* Center Icon */}
                <div className="relative flex items-center justify-center">
                    <div className="w-16 h-16 rounded-full border-2 border-purple-400 bg-transparent flex items-center justify-center shadow-[0_0_15px_rgba(168,85,247,0.5)]">
                        {/* Inner diamond shape implies an eye pupil or similar */}
                        <IoEyeOutline className="text-[#F5E6CC] w-8 h-8 drop-shadow-[0_0_8px_rgba(245,230,204,0.8)]" />
                    </div>
                    {/* Ring Glow */}
                ...
                <div className="flex flex-col items-end">
                    <span className="text-purple-300 text-xs font-semibold tracking-wider mb-1">DROP IN:</span>
                    <div className="text-[#F5E6CC] font-mono text-3xl font-bold tracking-widest leading-none">
