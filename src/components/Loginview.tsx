    ...
    <div className="w-full h-full overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-white text-sm leading-relaxed text-left">
          Mmeko is the only platform where creators can host Fan Meets, Fan Dates, Fan Calls, and Exclusive Contents with a clear safety framework and keep 100% of their earnings. 
        </p>
      </div>
