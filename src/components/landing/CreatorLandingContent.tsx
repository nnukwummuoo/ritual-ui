  ...
  return (
    <>
      ...
      <div className="lp">
        ...
        {/* STATS */}
        <div className="stats">
          <div className="stat reveal"><p className="step-title">100%<span className="stat-n">100%</span>Earnings you keep</p></div>
          <div className="stat reveal d1"><p className="step-title">100%<span className="stat-n">0s</span>Payout delay</p></div>
          <div className="stat reveal d2"><p className="step-title">100%<span className="stat-n">100%</span>30 minutes maximum for meets</p></div>
