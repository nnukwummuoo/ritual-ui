  ...
  return (
    <>
      ...
      <div className="lp">
        ...
        {/* STATS */}
        <div className="stats">
          <div className="stat reveal"><div className="stat-1">Keep<span className="stat-n">100%</span></div><div className="stat-l">of your earnings</div></div>
          <div className="stat reveal d1"><div className="stat-l">Instant payout</div><div className="stat-n">zero delay</div></div>
