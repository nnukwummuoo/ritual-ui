...
const FAQ_CREATORS = [
  ...
  { q: "Why do fans trust Mmeko?", a: "Hesitant clients prefer Mmeko because their payment is protected until the booking is complete. Instead of handing money to a stranger, Mmeko holds it securely, giving them confidence to pay upfront." },
  ...
  { q: "How many days do I have to contact Mmeko Support if a fan refuses to mark a meet/date as complete, fails to respond within 24 hours, doesn’t show up, or requests cancellation after the booking has already been accepted?", a: "You have 18 days from the booking request date to contact Mmeko Support. If Support is not contacted within 18 days, the fan will automatically receive a refund on day 20." },
