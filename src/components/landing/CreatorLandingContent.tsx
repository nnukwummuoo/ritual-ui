...
const FAQ_CREATORS = [
  ...
  { q: "What if the fan doesn't mark the meet as complete?", a: "Reach out to mmeko Support directly via the platform. Our team will review your on-platform chat history and meeting details, and release your payment immediately. We always have your back." },
  { q: "Can a fan cancel a request I already accepted?", a: "No. Once a creator accepts a request, it is final. If a fan does not show up, stops responding to messages, or asks to cancel, contact Support immediately and we will review and release your payment immediately. If Support is not contacted within 18 days from the appointment date, the payment will be automatically refunded to the fan." },
...
const FAQ_FANS = [
  ...
  { q: "What if the creator doesn't show up?", a: "If a creator does not attend the scheduled appointment, the fan will automatically receive a full refund. Refunds are released to the fan automatically on the 20th day from the appointment date." },
        ...
        <div id="payments">
          <div className="section">
            ...
            <div className="pay-callout reveal d3">
              ...
              <div><div className="pay-callout-title">What if the fan stops responding to messages, asks to cancel, doesn&apos;t show up or mark the meet as complete?</div><div className="pay-callout-desc">simply contact <strong>Mmeko Support</strong> and we will release your payment immediately. We always have your back.</div></div>
            </div>
          </div>
        </div>
