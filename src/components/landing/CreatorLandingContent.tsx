...
const FAQ_CREATORS = [
  ...
  { q: "What if a fan stops responding to messages, asks to cancel, doesn't show up or mark the meet as complete?", a: "Reach out to mmeko Support directly via the platform. Our team will review your on-platform chat history and meeting details, and release your payment immediately. We always have your back." },
