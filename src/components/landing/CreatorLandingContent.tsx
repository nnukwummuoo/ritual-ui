...
const FAQ_CREATORS = [
  ...
  { q: "What If a fan refuses to mark a meet/date as complete, fails to respond to messages within 24 hours, doesn't show up or requests cancellation after the meet/date has already been accepted?", a: "Reach out to mmeko Support directly via the platform. Our team will review your on-platform chat history and meeting details, and release your payment immediately. We always have your back." },
  { q: "Can a fan cancel a request I already accepted?", a: "No. Once a creator accepts a request, it is final. If a fan does not show up, fails to respond to messages within 24 hours, or asks to cancel, contact Support immediately and we will review and release your payment immediately. If Support is not contacted within 18 days from the booking request date, the payment will be automatically refunded to the fan." },
