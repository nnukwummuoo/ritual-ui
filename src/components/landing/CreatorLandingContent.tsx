        ...
        <div className="section-alt" id="safety">
          <div className="section">
            ...
            <div className="safety-grid">
              ...
              <div className="safety-card reveal d1"><div className="safety-icon-wrap">✅</div><div className="safety-title">Fan Verification</div><div className="safety-desc">All fans must verify their account with ID + selfie before booking. Creators receive booking requests only from verified fans, ensuring every meet starts with trust and safety.</div></div>
