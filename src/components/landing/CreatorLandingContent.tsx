...
const FAQ_CREATORS = [
  ...
  { q: "What if the fan stops responding?", a: "If a fan books you and then goes silent, you are still protected. Keep all communication inside the Mmeko chat. If they don’t reply within 24 hours, contact Support and we will release the payment to you.\n\nThe reason is simple: if a fan is not responding, there is no real arrangement. You shouldn’t have to keep waiting or travel when they have gone silent. Your protection is in the chat record." },
  ...
  { q: "What If a fan refuses to mark a meet/date as complete, doesn't show up or asks to cancel?", a: " Simply contact mmeko support and we will release your payment immediately. We always have your back." },
  { q: "How many days do I have to contact Mmeko Support if a fan refuses to mark a meet/date as complete, doesn’t show up, or asks to cancel?", a: "You have 18 days from the booking request date to contact Mmeko Support. If Support is not contacted within 18 days, the fan will automatically receive a refund on day 20." },
  { q: "Can a fan cancel a request I already accepted?", a: "No. Once a creator accepts a request, it is final. If a fan does not show up, or asks to cancel, contact Support immediately and we will review and release your payment immediately." },
        ...
        <div id="payments">
          <div className="section">
            ...
            <div className="pay-callout reveal d3">
              ...
              <div><div className="pay-callout-title">What If a fan refuses to mark a meet/date as complete, doesn&apos;t show up or asks to cancel?</div><div className="pay-callout-desc">simply contact <strong>Mmeko Support</strong> and we will release your payment immediately. We always have your back.</div></div>
            </div>
          </div>
        </div>
        ...
        <div className="section-alt" id="safety">
          <div className="section">
            ...
            <div className="safety-grid">
              ...
              <div className="safety-card reveal d1"><div className="safety-icon-wrap">✅</div><div className="safety-title">Fan Verification</div><div className="safety-desc">All fans must verify their mmeko account by uploading a government ID and a selfie holding that ID before they can book. Creators only receive booking requests from verified fans and can review the fan&apos;s ID and selfie before accepting. This ensures every meet starts with trust and safety.</div></div>
            ...
            <div className="cmp-wrap reveal d2">
              <table className="cmp-table">
                ...
                <tbody>
                  ...
                  <tr><td className="td-feature">Fan Verification</td><td className="td-mmeko"><span className="ck">✓ Required</span></td><td className="td-other"><span className="cx">✗</span></td></tr>
