...
const FAQ_CREATORS = [
  ...
  { q: "How long do fan meets last?", a: "Fan meets default to 30 minutes — enough for a clear, comfortable, no-pressure interaction for everyone involved. If both you and the fan wish to continue, the fan can send an additional structured booking request to extend the session. You're never locked into ending things early if you'd both like to continue." },
  ...
  { q: "What are Fan Meet and Fan Date?", a: "• 🤝 Fan Meet – A short, casual meeting where you can greet your favorite creator, chat, and even take a selfie. It's about making a quick personal connection - defaults to 30 minutes for safety and fairness.\n• 🍽 Fan Date – A slightly more relaxed session where you spend time together in a safe public place — like grabbing coffee, eating, or walking — also defaults to 30 minutes for safety and fairness.\n• ⏱ Want more time? If both you and the fan wish to continue, the fan can send an additional structured booking request to extend — 30 minutes is the safe default, not a hard cutoff." },
...
const FAQ_FANS = [
  ...
  { q: "How long do fan meets last?", a: "Fan meets default to 30 minutes — enough for a clear, comfortable, no-pressure interaction for everyone involved. If both you and the creator wish to continue, the fan can send an additional structured booking request to extend the session. You're never locked into ending things early if you'd both like to continue." },
        ...
        <div className="section-alt" id="safety">
          <div className="section">
            ...
            <div className="safety-grid">
              ...
              <div className="safety-card reveal d1"><div className="safety-icon-wrap">⏱</div><div className="safety-title">30 Minutes by Default</div><div className="safety-desc">Fan meets default to 30 minutes, protecting you from pressure, overstay, and uncomfortable situations — boundaries are built into the platform itself. Want to keep the conversation going? the fan can send an additional structured booking request to extend the session, so you're always in control of how long a good meet lasts.</div></div>
