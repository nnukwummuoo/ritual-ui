      ...
      <div className="w-full max-w-md bg-[#111624] border border-white/10 rounded-2xl shadow-[0_30px_70px_-25px_rgba(0,0,0,0.7)] overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-4">
          <p className="text-sm text-gray-300 leading-relaxed">
            Mmeko is a space built on genuine connection, not explicit exposure. To protect that — for you and for everyone here — visible nipples or genitals are not allowed in the {context === "ritual" ? "ritual page" : "homepage"}. Cleavage, and bikinis are welcome.
          </p>
